"""
Shared database connection for Predictive Maintenance demo.
...
TABLES = [
    "aircraft_fleet", "sensor_telemetry", "maintenance_history",
    "parts_inventory", "component_lifecycle", "flight_schedule",
    "hangar_availability", "anomaly_alerts",
]
